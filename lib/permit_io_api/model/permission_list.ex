...
defmodule PermitIoAPI.Model.PermissionList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Permission.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.PermissionList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Permission, options)
  end
end
