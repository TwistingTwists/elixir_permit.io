...
defmodule PermitIoAPI.Model.EnvironmentList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Environment.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.EnvironmentList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Environment, options)
  end
end
