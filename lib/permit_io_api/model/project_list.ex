...
defmodule PermitIoAPI.Model.ProjectList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Project.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.ProjectList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Project, options)
  end
end
