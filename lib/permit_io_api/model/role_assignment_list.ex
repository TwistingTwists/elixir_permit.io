...
defmodule PermitIoAPI.Model.RoleAssignmentList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.RoleAssignment.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.RoleAssignmentList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.RoleAssignment, options)
  end
end
