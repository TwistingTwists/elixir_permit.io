...
defmodule PermitIoAPI.Model.DecisionLogResponseList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"countFiltered" => integer() | nil,
    :"count" => integer() | nil,
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.DecisionLogResponse.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.DecisionLogResponseList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.DecisionLogResponse, options)
  end
end
