...
defmodule PermitIoAPI.Model.TenantList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Tenant.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.TenantList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Tenant, options)
  end
end
