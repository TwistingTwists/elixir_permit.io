...
defmodule PermitIoAPI.Model.OrganizationList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Organization.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.OrganizationList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Organization, options)
  end
end
