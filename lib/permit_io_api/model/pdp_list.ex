...
defmodule PermitIoAPI.Model.PdpList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Pdp.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.PdpList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Pdp, options)
  end
end
