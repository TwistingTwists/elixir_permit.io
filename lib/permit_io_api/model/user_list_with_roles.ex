...
defmodule PermitIoAPI.Model.UserListWithRoles do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :"count" => integer() | nil,
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.UserWithRoles.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.UserListWithRoles do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.UserWithRoles, options)
  end
end
