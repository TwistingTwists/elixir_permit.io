...
defmodule PermitIoAPI.Model.ActionList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Action.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.ActionList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Action, options)
  end
end
