...
defmodule PermitIoAPI.Model.RoleList do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"url" => String.t,
    :"data" => [PermitIoAPI.Model.Role.t]
  }
end

defimpl Poison.Decoder, for: PermitIoAPI.Model.RoleList do
  import PermitIoAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"data", :list, PermitIoAPI.Model.Role, options)
  end
end
